...
These are deliberate simplifications for a project meant to be read and run in
five minutes, and they are listed in the README's Known limitations too.

## Reporting a vulnerability

If you find something that is a real problem rather than one of the above -
a way to execute code from a crafted event, a dependency with a known CVE that
the pinned version has not picked up, a secret committed by mistake - please
open a [security advisory](https://github.com/BrishavDebnath/streaming-product-affinity/security/advisories/new)
rather than a public issue, or email brishavdevnath@gmail.com.
